...
## Changes:
- tech.md: Framework version update
...
### Bootstrap
**Input**: Empty steering, project  
**Output**: 3 files with patterns

### Sync
**Input**: Existing steering, new directory  
**Output**: Updated structure.md, flagged non-compliant files, suggested custom steering
