...
allowed-tools: Bash, Glob, Grep, LS, Read, Write, Edit, MultiEdit, Update, WebSearch, WebFetch, Skill
...
### Step 4: External Quality Check

Execute design quality check for additional perspective on design quality.

**Note**: External quality checks are optional and can be skipped if not available.
