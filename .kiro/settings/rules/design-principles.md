...
When designing or implementing features, **load and apply domain-specific standards from `.kiro/steering/`**:

<!-- TODO: Customize this table for your project's steering files -->

| Domain | Steering File | When to Apply |
|--------|---------------|---------------|
| **Architecture** | `tech.md` | System architecture and technology choices |
| **Project Structure** | `structure.md` | Directory organization and code layout |
| **Design System** | `design.md` | UI components, styling, accessibility |
| **Testing** | `testing.md` | Test strategy, coverage, patterns |

### Mandatory Checks
Before finalizing design or implementation:
1. **Identify affected domains** from the table above
2. **Read corresponding steering files**
3. **Verify alignment** with documented patterns and constraints
4. **Document deviations** with rationale if standards cannot be followed
