...
### 5. Domain-Specific Standards Alignment
<!-- TODO: Customize for your technology domains -->
- **Verify steering principles**: Check alignment with project-specific steering files in `.kiro/steering/`
- **Architecture patterns**: Ensure design follows documented architectural patterns
- **Technology standards**: Validate use of approved technologies and versions
- **Code standards**: Check naming conventions, error handling, logging strategies
- **Security patterns**: Verify authentication and authorization implementations
- **Data patterns**: Ensure data modeling follows project standards
